 ...
 * |---------+------+------+------+------+------|-[----+-[]---+-]----+------+------+------|
 * |OsmLShft |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |  Up  | osl  |
 * |---------+------+------+------+------+------+------+------+------+------+------+------|
 * | OsmCtrl | Ldr  | Alt  | GUI  |Lower |    Space    |Raise |  /   | Down |  Up  |Right |
 * `--------------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  OSM(MOD_LSFT),    KC_Z,    KC_X,    KC_C,        KC_V,    KC_B,     KC_N,    KC_M,     KC_COMM, KC_DOT,  KC_UP, TG(_RAISE),
  OSM(MOD_LCTL),    KC_LEAD,     KC_LGUI, KC_LALT,     LOWER,   KC_SPC,   KC_SPC,  RAISE,    KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT
),    
 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | ESC  |      | Alt  | Lower |    Space    |Raise|  -   |   =  |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_GAME] = LAYOUT_preonic_grid(
  ...
  KC_LCTL,      KC_ESC,     KC_LGUI,     KC_LALT,      LOWER,          KC_SPC,    KC_SPC,   RAISE,    KC_MINS,  KC_EQL,   _______,   _______ 
),
/* Dota
 * ,-----------------------------------------------------------------------------------.
 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |      |  '   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |ESC   | Win  | Alt  | Lower|    Space    |Raise |  -   |   =  |      |      |
 * `-----------------------------------------------------------------------------------'
 */
...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______,    _______, _______, _______,  S(KC_SLSH), _______, _______, _______, _______, _______
),
/* Raise NUMPAD
 * ,-----------------------------------------------------------------------------------.
 * | ____ |      |      |      |      |   =  |   +  |      |      |      |      |       |
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  _______, KC_6,    KC_7,     KC_8,    KC_9,    KC_0,     KC_PSLS, KC_CIRC, _______, _______, _______, TG(_RAISE),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |KC_ASDN|KC_ASUP|KC_ASRP|      |      |      |MAIL  |      |      |      |DEBUG |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, KC_ASDN, KC_ASUP,  KC_ASRP, _______, _______, _______, KC_VOLU, _______, _______, _______,  DEBUG,
  ...
  RGB_TOG, RGB_M_P, _______,  _______, _______, _______, _______, _______, _______, _______, _______,  KC_ASTG  
),
};
...
void matrix_scan_user(void) {
  ...
  LEADER_DICTIONARY() {
    ...
    SEQ_TWO_KEYS(KC_P, KC_P) {
      SEND_STRING("$$$3RRR" SS_TAP(X_LEFT) SS_TAP(X_LEFT) SS_TAP(X_LEFT) SS_TAP(X_LEFT));
      did_leader_succeed = true;
    }
    SEQ_ONE_KEY(KC_E) {
